  ...
  function parseYearlyCsvStatement(text) {
    ...
    for (var r = 1; r < rows.length; r++) {
      ...
      if (!designName && isReturn) {
        ...
        // the design name still appears inline in the Description text.
        var designMatch = description.match(/Design:\s*(.+?)\s*\(Adjustment/i);
      ...
      var dedupeKey = dateRaw + "::" + (designId || "") + "::" + amount;
